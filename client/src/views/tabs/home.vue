                ...
                <div v-for="invoice in initialInvoices">
                  ...
                  <div class="invoice_status_wrapper">
                    <div>
                      ...
                      <p class="invoice_wrapper_subtitle">{{ userProfile?.firstname }} {{ userProfile?.lastname }}, {{ invoice.last_activity }}</p>
                    </div>
                    <div>
            ...
            <div class="invoices_wrapper">
              <div>
                <div v-for="invoice in loggedinuser?.invoices">
                  ...
                  <div v-else-if="invoice.status == 'open'" class="invoice_wrapper" @click="InvoiceToggler(invoice)">
                    <div class="invoice_status_wrapper">
                      <div>
                        <p class="invoice_wrapper_title">Factuur-{{ invoice.number }}</p>
                        <p class="invoice_wrapper_subtitle">{{ userProfile?.firstname }} {{ userProfile?.lastname }}, {{ invoice.last_activity }}</p>
...
import { IonPage, useIonRouter, IonHeader, IonToolbar, IonTitle, IonContent, IonSpinner, onIonViewWillEnter, onIonViewWillLeave, onIonViewDidEnter, onIonViewDidLeave,  } from '@ionic/vue';
import { ref, onMounted, onUnmounted, watch, computed  } from 'vue';
import axios from 'axios'
import { alertCircleSharp, checkmarkCircleSharp, arrowBackOutline, chatbubbleEllipsesSharp, ellipsisHorizontalOutline, closeSharp } from 'ionicons/icons';
